...
```{r }
datapath <- "D:\\Laptop 2021\\ANSD\\Suivi QG EHCVM 2 V1\\ehcvm2_rejet-master\\data\\02_combined"
library(haven)
...
```{r }
tableconversion <- "D:\\Laptop 2021\\ANSD\\Suivi QG EHCVM 2 V1\\ehcvm2_rejet-master\\data\\00_resource"
library(readxl)
...
labels = c("Taille unique" = 0, Petit = 1, 
    Moyen = 2, Grand = 3, Quart = 4, Demi = 5, Entier = 6, "Tr�s Petite" = 7
...
```{r }
knitr::spin("cours_06_manipulation", knit = FALSE)
```
